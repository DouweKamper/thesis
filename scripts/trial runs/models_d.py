...
a function that returns hydraulic heads for all MODFLOW6 models designed so far 
"""
...
def model_output(MODEL_NR, LOCATIONS=None, K=None):
    """
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        # %% run simulation
        sim.write_simulation(silent=True)  # silent influences what is printed
